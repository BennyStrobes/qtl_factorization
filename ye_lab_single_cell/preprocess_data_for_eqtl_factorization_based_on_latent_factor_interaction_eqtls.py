...
# Input files
latent_factor_interaction_eqtl_genome_wide_sig_results_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_results_genome_wide_signficant_bf_fdr_0.05.txt'
...
latent_factor_interaction_test_names_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_variant_gene_pairs.txt'
...
all_test_names_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_variant_gene_pairs.txt'
eqtl_factorization_test_names_file = output_dir + 'eqtl_factorization_lf_interaction_no_cap_2.5_eqtl_input_test_names.txt'
...
all_gene_expression_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_expression.txt'
eqtl_factorization_expression_file = output_dir + 'eqtl_factorization_lf_interaction_no_cap_2.5_eqtl_input_expression.txt'
...
all_test_genotype_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_genotype.txt'
eqtl_factorization_genotype_file = output_dir + 'eqtl_factorization_lf_interaction_no_cap_2.5_eqtl_input_genotype.txt'
...
covariate_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_covariates.txt'
lf_covariate_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_latent_factors.txt'
covariate_with_intercept_file = output_dir + 'eqtl_factorization_lf_interaction_no_cap_2.5_eqtl_input_covariates.txt'
generate_covariate_file(covariate_file, lf_covariate_file, covariate_with_intercept_file)

# Generate sample overlap file
sample_overlap_input_file = working_dir + 'latent_factor_interaction_no_cap_2.5_eqtl_input_sample_overlap.txt'
sample_overlap_output_file = output_dir + 'eqtl_factorization_lf_interaction_no_cap_2.5_eqtl_input_sample_overlap.txt'
