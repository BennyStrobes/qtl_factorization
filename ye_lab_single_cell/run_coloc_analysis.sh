...
sig_eqtl_file=$surge_interaction_eqtl_dir"surge_interaction_eqtl_cis_window_200000_factor_v3_perm_interaction_only_interaction_eqtl_results_latent_factor_"$latent_factor_num"_genome_wide_signficant_bf_fdr_0.05.txt"
all_eqtl_file=$surge_interaction_eqtl_dir"surge_interaction_eqtl_cis_window_200000_factor_v3_perm_interaction_only_interaction_eqtl_results_latent_factor_"$latent_factor_num"_merged.txt"
if false; then
