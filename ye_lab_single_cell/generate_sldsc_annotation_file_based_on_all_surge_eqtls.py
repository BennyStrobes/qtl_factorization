...
for chrom_num in range(1,23):
	...
	surge_anno_file = sldsc_processed_data_dir + 'surge_eqtls_' + str(pvalue_thresh) + '.' + str(chrom_num) + '.annot'
	joint_surge_anno_file = sldsc_processed_data_dir + 'joint_surge_eqtls_' + str(pvalue_thresh) + '.' + str(chrom_num) + '.annot'
