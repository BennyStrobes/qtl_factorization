...
num_hvgs = [2000, 4000, 6000]

for num_hvg in num_hvgs:
	# Load in adata file before filtering to HVG
	...
	# output file stem
	#######################	
	output_file_stem = processed_expression_dir + 'scran_normalization_hvg_' + str(num_hvg) + '_regress_batch_' + regress_out_batch
