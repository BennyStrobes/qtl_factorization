...
def get_total_number_of_samples(sample_names_file, loading_file):
	num_lines1 = 0
...
sample_names_file_parr = sys.argv[3]
loading_file_parr = sys.argv[4]
job_number = int(sys.argv[5])
num_jobs = int(sys.argv[6])


# First get total number of samples
num_samples = get_total_number_of_samples(sample_names_file, loading_file)
...
filter_lines_in_file(loading_file, loading_file_parr, start_number, end_number)
