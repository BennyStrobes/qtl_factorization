...
expression_pcs_file = processed_expression_dir + 'pca_scores_knn_boosted_residual_expression_k_30_euclidean_pca_median_gaussian_kernel_regress_out_batch_False_sle_individuals.txt'
