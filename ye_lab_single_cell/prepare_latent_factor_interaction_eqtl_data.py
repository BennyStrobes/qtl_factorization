...
# Input files
expression_file = processed_expression_dir + 'pseudobulk_scran_normalization_hvg_6000_regress_batch_True_individual_clustering_leiden_resolution_10.0_none_sample_norm_zscore_gene_norm_normalized_expression.txt'
sample_covariate_file = genotype_data_dir + 'pseudobulk_sample_covariates_with_genotype_pcs.txt'
expression_pcs_file = processed_expression_dir + 'pseudobulk_scran_normalization_hvg_6000_regress_batch_True_individual_clustering_leiden_resolution_10.0_none_sample_norm_zscore_gene_norm_pca_scores.txt'

# Output files
eqtl_variant_gene_pairs_file = latent_factor_interaction_eqtl_dir + 'latent_factor_interaction_hvg_6000_10.0_none_zscore_eqtl_input_variant_gene_pairs.txt'
eqtl_expression_file = latent_factor_interaction_eqtl_dir + 'latent_factor_interaction_hvg_6000_10.0_none_zscore_eqtl_input_expression.txt'
eqtl_genotype_file = latent_factor_interaction_eqtl_dir + 'latent_factor_interaction_hvg_6000_10.0_none_zscore_eqtl_input_genotype.txt'
eqtl_sample_overlap_file = latent_factor_interaction_eqtl_dir + 'latent_factor_interaction_hvg_6000_10.0_none_zscore_eqtl_input_sample_overlap.txt'
eqtl_covariate_file = latent_factor_interaction_eqtl_dir + 'latent_factor_interaction_hvg_6000_10.0_none_zscore_eqtl_input_covariates.txt'
eqtl_lf_file = latent_factor_interaction_eqtl_dir + 'latent_factor_interaction_hvg_6000_10.0_none_zscore_eqtl_input_latent_factors.txt'
