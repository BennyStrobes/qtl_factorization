...
sample_covariates_file=$processed_pseudobulk_expression_dir"pseudobulk_scran_normalization_regress_batch_True_individual_clustering_leiden_resolution_10.0_sample_covariates.txt"
if false; then
