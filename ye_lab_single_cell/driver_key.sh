...
sample_covariates_file=$processed_expression_dir"cluster_pseudobulk_leiden_no_cap_5_sample_covariates.txt"
if false; then
...
output_stem=$eqtl_factorization_results_dir"eqtl_factorization_results_lf_interaction_egenes_joint_5_"$model_name"_results_k_init_"$num_latent_factors"_lambda_v_"$lambda_v"_seed_"$seed"_init2_"
