...
sample_covariates_file=$processed_expression_dir"cluster_tmm_ign_pseudobulk_leiden_no_cap_2.5_sample_covariates.txt"
if false; then
...
output_stem=$eqtl_factorization_results_dir"eqtl_factorization_results_lf_interaction_egenes_"$model_name"_results_k_init_"$num_latent_factors"_lambda_v_"$lambda_v"_seed_"$seed"_var_param_"$variance_param"_"
if false; then
...
## Run eqtl factorization!
#############################################
sample_overlap_file=$eqtl_factorization_input_dir"eqtl_factorization_lf_interaction_joint_5_eqtl_input_sample_overlap.txt"
expression_training_file=$eqtl_factorization_input_dir"eqtl_factorization_lf_interaction_joint_5_eqtl_input_expression.npy"
genotype_training_file=$eqtl_factorization_input_dir"eqtl_factorization_lf_interaction_joint_5_eqtl_input_genotype.npy"
covariate_file=$eqtl_factorization_input_dir"eqtl_factorization_lf_interaction_joint_5_eqtl_input_covariates.txt"
num_latent_factors="20"
lambda_v="1"
model_name="eqtl_factorization_vi"
seed="1"
...
output_stem=$eqtl_factorization_results_dir"eqtl_factorization_results_lf_interaction_egenes_joint_5_"$model_name"_results_k_init_"$num_latent_factors"_lambda_v_"$lambda_v"_seed_"$seed"_var_param_"$variance_param"_"
if false; then
