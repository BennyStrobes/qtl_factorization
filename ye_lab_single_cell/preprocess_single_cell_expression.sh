...
python generate_pseudobulk_expression.py $processed_expression_dir $processed_pseudobulk_expression_dir $genotyped_individuals_file $cluster_resolution $regress_out_batch $num_hvg $isg_score_file $cell_isg_score_file
fi
if false; then
cluster_resolution="10.0"
num_hvg="4000"
