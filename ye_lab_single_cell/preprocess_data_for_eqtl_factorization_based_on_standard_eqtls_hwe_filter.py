...
def extract_eqtl_factorization_tests(test_names_file, cross_tissue_genome_wide_sig_results_file, num_genes, valid_variants):
	dicti = {}
	binary_arr = []
	temp_dicti = {}
	used_variants = {}
...
test_eqtl_dicti, test_eqtl_binary_arr = extract_eqtl_factorization_tests(latent_factor_interaction_test_names_file, latent_factor_interaction_eqtl_genome_wide_sig_results_file, num_genes, valid_variants)
...
eqtl_factorization_test_names_file = output_dir + 'eqtl_factorization_standard_eqtl_hvg_6000_10.0_no_cap_15_none_zscore_hwe_filter_eqtl_input_test_names.txt'
...
eqtl_factorization_expression_file = output_dir + 'eqtl_factorization_standard_eqtl_hvg_6000_10.0_no_cap_15_none_zscore_hwe_filter_eqtl_input_expression.txt'
...
eqtl_factorization_genotype_file = output_dir + 'eqtl_factorization_standard_eqtl_hvg_6000_10.0_no_cap_15_none_zscore_hwe_filter_eqtl_input_unnormalized_genotype.txt'
...
covariate_with_intercept_file = output_dir + 'eqtl_factorization_standard_eqtl_hvg_6000_10.0_no_cap_15_none_zscore_hwe_filter_eqtl_input_covariates.txt'
...
sample_overlap_output_file = output_dir + 'eqtl_factorization_standard_eqtl_hvg_6000_10.0_no_cap_15_none_zscore_hwe_filter_eqtl_input_sample_overlap.txt'
