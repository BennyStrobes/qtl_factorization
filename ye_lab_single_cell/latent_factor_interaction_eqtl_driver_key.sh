...
#############################################
# Input data
qtl_expression_file=$latent_factor_interaction_eqtl_dir"latent_factor_interaction_hvg_6000_10.0_no_cap_none_zscore_eqtl_input_expression.txt"
qtl_genotype_file=$latent_factor_interaction_eqtl_dir"latent_factor_interaction_hvg_6000_10.0_no_cap_none_zscore_eqtl_input_genotype.txt"
qtl_covariate_file=$latent_factor_interaction_eqtl_dir"latent_factor_interaction_hvg_6000_10.0_no_cap_none_zscore_eqtl_input_covariates.txt"
qtl_interaction_factor_file=$latent_factor_interaction_eqtl_dir"latent_factor_interaction_hvg_6000_10.0_no_cap_none_zscore_eqtl_input_latent_factors.txt"
qtl_test_names_file=$latent_factor_interaction_eqtl_dir"latent_factor_interaction_hvg_6000_10.0_no_cap_none_zscore_eqtl_input_variant_gene_pairs.txt"
qtl_sample_overlap_file=$latent_factor_interaction_eqtl_dir"latent_factor_interaction_hvg_6000_10.0_no_cap_none_zscore_eqtl_input_sample_overlap.txt"
