...
parser.add_argument('--logout', default='ldsc', type=str,
	help='Output filename prefix. If --out is not set, LDSC will use ldsc as the '
	'defualt output filename prefix.')
...
parser.add_argument('--multi_single_anno', default=None, type=str,
	help='Filename of a file where each line corresponds to an annotation to test, with current anno')
...
if __name__ == '__main__':
	...
	try:
		...
		# summary statistics
			...
			elif args.h2 and args.multi_single_anno:
				sumstats.estimate_h2_for_additional_multiple_single_annotations_independently(args,log)
			elif args.h2:
